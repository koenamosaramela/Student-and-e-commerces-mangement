 ...
 *It uses ASP.NET Core MVC to manage the views and actions related to student records.
 *The Index action method displays a paginated list of students.
 *The Details action method displays the details of a specific student.
 *The Create action method allows users to create a new student record.
 *The Edit action method allows users to edit an existing student record.
 *The Delete action method allows users to delete a student record.
 *The Ethuto action method displays a specific view.
 *This controller uses dependency injection to access the student repository and the web host environment.
